...
const Signin = () => {
  return (
    ...
    <div className="container">
        <div className="row">
        <div className="col-lg-5 column  d-flex justify justify-content-center align-items-center">
                <HeadingComp first="Sign" second="In"/>
            </div>
            <div className="col-lg-7 column d-flex justify justify-content-center align-items-center">
